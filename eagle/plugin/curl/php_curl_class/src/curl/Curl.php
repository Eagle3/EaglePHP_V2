...
use \plugin\curl\php_curl_class\src\curl\ArrayUtil;
use \plugin\curl\php_curl_class\src\curl\Decoder;
...
class Curl
{
    ...
    private $jsonDecoder = '\plugin\curl\php_curl_class\src\curl\Decoder::decodeJson';
    private $jsonDecoderArgs = array();
    private $jsonPattern = '/^(?:application|text)\/(?:[a-z]+(?:[\.-][0-9a-z]+){0,}[\+\.]|x-)?json(?:-[a-z]+)?/i';
    private $xmlDecoder = '\plugin\curl\php_curl_class\src\curl\Decoder::decodeXml';
    ...
    public function __construct($base_url = null)
    {
        ...
        //https证书不验证
        $this->setOpt(CURLOPT_SSL_VERIFYPEER, false ); // https不验证证书
        $this->setOpt(CURLOPT_SSL_VERIFYHOST, false ); // https不验证证书
        //$this->setOpt(CURLOPT_PROXY,'127.0.0.1:8888'); //设置代理服务器，可以用作抓包使用
    }
    ...
    {
        $this->jsonDecoder = '\plugin\curl\php_curl_class\src\curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\plugin\curl\php_curl_class\src\curl\Decoder::decodeXml';
    }
